...
class RtosHw final : public Rtos
{
    ...
    public:
        ...
        //bool     SendQueue                            (const std::string & v_name)        override;
        //bool     ReceiveQueue                         (const std::string & v_name)        override;
