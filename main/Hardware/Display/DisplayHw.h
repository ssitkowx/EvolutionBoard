...
class DisplayHw : public Display
{
    ...
    public:
        ...
        void     DrawRect       (const uint16_t v_xPos, const uint16_t v_yPos, const uint16_t v_length, const uint16_t v_width, const uint16_t v_color) override;
